...
function About({}: Props) {
  return (
    <div className='p-3 w-full gap-3 flex flex-col md:w-3/4' id='about'>
        ...
        <h2 className='text-cyan-600 dark:text-green-200 italic text-lg'>Curious Pursuit <span className='not-italic'>|</span> <span className='text-sm'>bit by bit</span></h2>
        ...
        <p>Over the past four years, I have honed my skills in full-stack web development, specializing in JavaScript | TypeScript and leveraging the Next.js framework—a powerful React | Node hybrid. Additionally, I have hands-on experience crafting applications using Python and the Flask framework. My expertise extends to developing solutions that integrate with headless Content Management Services (CMS) and connect to databases such as MongoDB and PostgreSQL.
        </p>
